...
>(({ className, children, ...props }, ref) => (
  <ModalPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        'fixed top-1/2 left-1/2 z-50 w-[calc(100%-2rem)] max-h-[88vh] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-md border bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-bottom-2 data-[state=open]:slide-in-from-bottom-2',
        className,
      )}
      {...props}
    >
